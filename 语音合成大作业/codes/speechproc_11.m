function speechproc()
    ...
    for n = 3:FN
        ...
        % (3) 在此位置写程序，观察预测系统的零极点图
            zplane(E,A); %nominator,denominator;Pred coef A as denominator
        end
        ...
        [rec_ftr,zi_rec] = filter(1,A,exc_ftr,zi_rec); %用残差作为输入
